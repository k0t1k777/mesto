...
// showErrorMessage
// const currentInputErrorContainers = Array.from(document.querySelectorAll(`#${input.id}-error`));

//   log(currentInputErrorContainers)
//   currentInputErrorContainers.forEach(input => {
//     input.addEventListener("input", () => {
//           currentInputErrorContainers.classList.add('popup__error_visible')
//           log(dfdf)
//     })
//   })
// hideErrorMessage
